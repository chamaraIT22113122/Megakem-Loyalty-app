...
import { Dashboard as DashboardIcon, People, Category, TrendingUp, Star, Notifications, NotificationsOff, Assessment, FileDownload, CalendarMonth, NavigateBefore, NavigateNext, Loop, Speed, ShowChart, Timeline, Build, Insights } from '@mui/icons-material';
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip as RechartsTooltip, ResponsiveContainer } from 'recharts';

export default function Dashboard(props) {
  const { stats, scanHistory, dashboardStartDate, dashboardEndDate, setDashboardStartDate, setDashboardEndDate, dateFilter, setDateFilter, loadAdminData, notificationPrefs, setNotificationPrefs, autoRefresh, setAutoRefresh, showCalendarView, setShowCalendarView, calendarViewMonth, setCalendarViewMonth, calendarViewYear, setCalendarViewYear, selectedCalendarDate, setSelectedCalendarDate, dailyReport, setDailyReport, loadCalendarData, setExpandedCardDialog, handleExportAllScans, handleExportProducts, isMainAdmin, handleExportUsers, activityLog, members, handlePreviousMonth, handleNextMonth, calendarData, handleCalendarDateChange, setDailyReportDialog, comparisonData, allScans, products, getTrendChartData, SriLankaZoneMap, applicatorStats, users } = props;
            ...
            {(isMainAdmin && typeof isMainAdmin === 'function' ? isMainAdmin() : isMainAdmin) && (
